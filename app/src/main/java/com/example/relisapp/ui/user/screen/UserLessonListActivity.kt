...
import com.example.relisapp.ui.user.screen.BaseUserScreen
import com.example.relisapp.ui.user.screen.UserLessonListScreen
import com.example.relisapp.ui.user.screen.UserTab
...
// Truyền cả lessonDao và resultDao vì LessonRepository cần cả 2
        val repo = LessonRepository(db.lessonDao(), db.resultDao())

        lessonViewModel = ViewModelProvider(
            this,
            LessonViewModelFactory(repo)
