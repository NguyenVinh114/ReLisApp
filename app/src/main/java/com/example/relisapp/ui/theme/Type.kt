...
val Typography = Typography(
    ...
    // Dùng cho tiêu đề quan trọng, dưới display
    headlineLarge = TextStyle(
        fontFamily = FontFamily.Default,
        fontWeight = FontWeight.SemiBold, // In đậm vừa phải cho tiêu đề
        fontSize = 32.sp,
        lineHeight = 40.sp,
        letterSpacing = 0.sp
    ),
    ...
    // Dùng cho tiêu đề phụ, tiêu đề trong các Card, Dialog
    ...
    // Dùng cho văn bản nội dung chính
    bodyLarge = TextStyle(
        fontFamily = FontFamily.Default,
        fontWeight = FontWeight.Normal,
        fontSize = 16.sp,
    ...
    // Dùng cho văn bản trên các nút (Button), tab
